package com.sanjay.studyandmaster;
...
public class ControllerServlet extends HttpServlet {
	...
	@Resource(name="jdbc/sanjaystudyandmaster")
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          //headings for certificate
            Font blue = new Font(FontFamily.HELVETICA, 30, Font.NORMAL, BaseColor.RED);
            Chunk blueText = new Chunk("Study and Master", blue);
            Paragraph p = new Paragraph(blueText);
            p.setAlignment(Element.ALIGN_CENTER);


            Font red = new Font(FontFamily.HELVETICA, 20, Font.NORMAL, BaseColor.BLUE);
            ...
            document.add(p4);
             ...
             Font l3 = new Font(FontFamily.HELVETICA, 15, Font.ITALIC, BaseColor.DARK_GRAY);
             Chunk l3Text = new Chunk("This application is developed by Hemantha Veera Sanjay Ponna", l3);
