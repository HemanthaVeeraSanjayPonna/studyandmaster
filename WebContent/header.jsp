...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top " >
  <a class="navbar-brand" href="home.jsp"> <em class="logo">StudyandMaster</em></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav ml-md-auto">
      ...
      <c:if test = "${checksession==null}">
         <li class="nav-item">
        <a class="nav-link" href="ControllerServlet?command=register">Sign up</a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="ControllerServlet?command=login">Sign in</a>
      </li>
      </c:if>
       ...
       <li class="nav-item">
        <a class="nav-link" href="ControllerServlet?command=profile">Profile</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="ControllerServlet?command=logout">Sign out</a>
      </li>
