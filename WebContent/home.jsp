...
<center><h1 class="intro" style="padding:1.5%;color:green">Master Online Trending Courses</h1></center>
<center>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h1  class="h1"style="color:#000000; background-color:#bbf1fa;">Our Courses Matter</h1>
           ...
           <!-- core if tags are used here in order to check whether the user session is present or not  -->
            ...
            <a href="ControllerServlet?command=register"><button class="btn-lg btn-danger">Sign Up Now in a Minute</button></a>
             </c:if>
             <c:if test="${checksession!=null }">
             <button type="button">Thank you. Your Door to Mastering Skills is Now Unlocked!</button>
             </c:if>        
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            ...
            <h1 class=" h1"style="color:#000000; background-color:#bbf1fa;">Learn at your convenience.</h1>
            <p class="a"></p>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            ...
            <h1 class="h1"style="color:#000000; background-color:#bbf1fa;">Earn a Certificate after Successful Completion of Quizzes.</h1>
            <p class="a"></p>
          </div>
        </div>
  ...
  <a href="ControllerServlet?command=course&name=1">
    ...
    <div class="card-body " style="background-color:#f7f2e7 ;">
      ...
      <c:if test = "${checksession==null}">
       ...
       <a href="ControllerServlet?command=register"><button class="card-text btn-md btn-primary" >Sign Up to access Content</button></a>
    </div>
      </c:if>
...
<div class="container-fluid" style="padding: 0% 15%;" >
  <div class="row">
    ...
    <div class="col-lg-4 col-md-12" style="padding:5%;">
      ...
      <i class="fas fa-server fa-4x" style="padding-bottom:20px;"></i>
    <h3 class="h33">Gain Knowledge</h3>
    <p class="pp">Easy to Learn.</p>
  </center>
</div>
<div class="col-lg-4 col-md-12" style="padding:5%;">
<center>
<i class="fas  fa-network-wired fa-4x" style="padding-bottom:20px;"></i>
    <h3 class="h33">Global Site Access</h3>
    <p class="pp">Anytime, Anywhere.</p>
  </center>
  </div>
<div class="col-lg-4 col-md-12" style="padding:5%;">
  <center>
  <i class="fas fa-certificate fa-4x" style="padding-bottom:20px;"></i>
    <h3 class="h33">Get a Certificate</h3>
    <p class="pp">Cool Quizzes to take.</p>
      </center>
  </div>
    </div>
</div>
