...
<%@ page import = "com.sanjay.studyandmaster.*, java.util.*,java.lang.reflect.Array" %>
...
function validate(){
 var arr=[];
	 ...
	 $("input:radio").each(function(){
		 if(arr.includes($(this).attr('name'))){
	...
	for(var i=0;i<arr.length;i++){
        if($('input[name='+arr[i]+']').is(':checked')){
 ...
 // for stopping the resubmission on refresh
